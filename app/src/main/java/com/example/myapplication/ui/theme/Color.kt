...
val md_theme_light_primary = Color(0xFF4361EE) // Vibrant Blue
...
val md_theme_dark_secondary = Color(0xFF93C5FD)
val md_theme_dark_onSecondary = Color(0xFF1E3A8A)
val md_theme_dark_secondaryContainer = Color(0xFF1D4ED8)
