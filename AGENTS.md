...
## 版本任务约定
- 用户通常会在任务开始前明确说明“本次任务属于哪个版本”，例如 `1.1.2`。
- 只要用户已经声明版本号，后续本轮功能开发、优化、缺陷修复、文档记录都默认归属该版本，不要自行改挂到其他版本。
- 涉及版本功能、优化项、发版说明整理时，默认同步更新仓库内的版本记录文档：`版本功能添加/优化.md`。
- 若用户尚未声明版本号，而需求又明显属于某一轮版本功能整理或发版收口，应先提醒并确认当前任务对应的版本号，再继续整理版本说明。
